...
void 		ofSetupOpenGL(ofPtr<ofAppBaseWindow> windowPtr, int w, int h, ofWindowMode screenMode);	// sets up the opengl context!
void 		ofSetupOpenGL(ofAppBaseWindow * windowPtr, int w, int h, ofWindowMode screenMode); // this is deprecated, use an ofPtr
void 		ofSetupOpenGL(int w, int h, ofWindowMode screenMode,int monitor=0);	// sets up the opengl context!
