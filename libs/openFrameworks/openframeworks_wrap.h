...
public:
    SwigDirector_ofPoint(PyObject *self);
    SwigDirector_ofPoint(PyObject *self, float _x, float _y, float _z = 0.0);
...
public:
    ...
    SwigDirector_ofRectangle(PyObject *self, ofRectangle const &r);
...
public:
    ...
    SwigDirector_ofColor(PyObject *self, float _r, float _g, float _b, float _a = 255.0);
    SwigDirector_ofColor(PyObject *self, ofColor const &color);
    SwigDirector_ofColor(PyObject *self, ofColor const &color, float _a);
    SwigDirector_ofColor(PyObject *self, float gray, float _a = 255.0);
...
class SwigDirector_ofBaseImage : public ofBaseImage, public Swig::Director {

public:
    SwigDirector_ofBaseImage(PyObject *self);
    virtual ~SwigDirector_ofBaseImage();
    virtual void draw(float x, float y);
    virtual void draw(float x, float y, float w, float h);
    virtual float getHeight();
    virtual float getWidth();
...
/* VTable implementation */
    PyObject *swig_get_method(size_t method_index, const char *method_name) const {
      ...
      if (!method) {
        ...
        method = PyObject_GetAttr(swig_get_self(), name);
        if (method == NULL) {
          std::string msg = "Method in class ofBaseImage doesn't exist, undefined ";
          msg += method_name;
          Swig::DirectorMethodException::raise(msg.c_str());
        }
        vtable[method_index] = method;
...
class SwigDirector_ofGstUtils : public ofGstUtils, public Swig::Director {

public:
    SwigDirector_ofGstUtils(PyObject *self);
    virtual ~SwigDirector_ofGstUtils();
...
public:
    ...
    virtual void setAnchorPoint(float x, float y);
    virtual void resetAnchor();
    virtual void allocate(int w, int h, int internalGlDataType);
    virtual void allocate(int w, int h, int internalGlDataType, bool bUseARBExtention);
